...
- **Testing:** Write unit and integration tests for both backend and frontend. Use mocks/stubs where
appropriate.
...
- For tests, use the same frameworks and match the style of existing tests, and generate comprehensive
test coverage, including edge cases, exception handling and data validation